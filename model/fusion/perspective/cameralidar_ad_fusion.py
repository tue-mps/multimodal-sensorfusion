...
class cameralidar_fusion_Afterdecoder(nn.Module):
    def __init__(self, channels_bev, blocks,detection_head,segmentation_head,config):
        super(cameralidar_fusion_Afterdecoder, self).__init__()
    ...
    def forward(self, cam_inputs, lidar_inputs):
        ...
        x_234 = self.lidaronly(lidar_inputs) #result after decoder from lidar decoder

        # here we fuse (concatenate) camera and lidar data
...
#
#     net = cameralidar_fusion_Afterdecoder(channels_bev=[16, 32, 64, 128],
#                                           blocks=[3, 6, 6, 3],
